...
data <- read.csv("DEGs_RTN_sigBoth.txt")
...
#png( "barplot_Mice_RTN.png", height = 2000, width = 2000, res=300)
pdf( "barplot_Mice_RTN.pdf", height = 10, width = 10)
mp=barplot(c(same, opposite), names.arg=c("same Dir", "opposite Dir"), cex.main=2, cex.axis=1.4, cex.lab=2, cex.names=1.7, main="RTN Directional Change Totals", ylab="", ylim=c(0,maxH+maxH/10))
